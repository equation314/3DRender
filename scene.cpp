...
{
    m_lights.push_back(new RectLight(Color(1, 1, 1), Vector3(0, 0.3, 0.8), Vector3(0.3, 0, 0), Vector3(0, 0.3, 0)));
    // m_lights.push_back(new PointLight(Color(1, 1, 1), Vector3(0, 0.3, 0.9)));

    Material* groundMaterial = new Material(Color(0.5, 0.5, 0.5), 1, 0);
    Material* mirrorMaterial = new Material(Color(0.9, 0.9, 0.9), 0.1, 0.8, 0.9);
    Material* redWall = new Material(Color(1, 0, 0), 0.9, 0.1);
    Material* blueWall = new Material(Color(0, 0, 1), 0.9, 0.1);
    Material* writeWall = new Material(Color(1, 1, 1), 0.9, 0.1);
    Material* blueGlass = new Material(Color(0.3, 0.3, 1), 0, 0.8, 0.4, 0.6, 1.5, Color(1, 1, 0));
    Material* writeGlass = new Material(Color(1, 1, 1), 0.2, 0.8, 0.1, 0.9, 2.5, Color(0, 0, 0));

    Object* ground = new Plane(writeWall, Vector3(0, 0, 1), 1);
    ...
    Object* ball1 = new Sphere(writeGlass, Vector3(0.6, 0.2, -0.6), 0.4);
    Object* ball2 = new Sphere(blueGlass, Vector3(-0.6, 0.2, -0.6), 0.4);
