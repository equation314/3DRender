...
struct Collision
{
    ...
    // 与物体相交
    Collision(const Vector3& start, const Vector3& dir, double t, const Vector3& n,
              const Object* obj, bool in = false);

    // 与物体相交，包含参数
    Collision(const Vector3& start, const Vector3& dir, double t, double u, double v, const Vector3& n,
              const Object* obj, bool in = false);
